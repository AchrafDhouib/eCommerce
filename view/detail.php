...
<body>
    ...
    $prd= new Product();
    $res=$prd->getProduct($_GET['id_prd']);
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="img/<?php echo $photo?>" alt="">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="img/<?php echo $photo?>" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="img/<?php echo $photo?>" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h4 class="font-weight-semi-bold mb-4"><del>$<?php echo $price?></del></h4>
                    <h3 class="font-weight-semi-bold mb-4">$<?php echo $price-($price/100*$discount)?></h3>
                ...
                <div class="owl-carousel related-carousel">
                    ...
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="img/<?php echo $row['photo']?>" alt="">
